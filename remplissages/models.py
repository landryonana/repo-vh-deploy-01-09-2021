...
class Evangelisation(models.Model): 
    ...
    author = models.ForeignKey(User, related_name='evangs', 
                                ...
                                null=True,
                                verbose_name="créer par ")
    boss = models.ManyToManyField(Participant, related_name='participations', blank=True, verbose_name="Qui sont présents ?")
    observation = models.TextField(verbose_name="Observations", null=True, blank=True)
    actif = models.CharField(max_length=15, choices=status, default='oui')
...
class Person(models.Model):
    ...
    boss = models.ManyToManyField(Participant, related_name='personnes', 
                        ...
                        help_text="selectionner les personnes ayant évangelisés cette personne")
